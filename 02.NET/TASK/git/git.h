...
#endif
// 设备信息 快递分拣系统-59-3
#define PROID "smartdevice&h9sj8FzJ0gy"															 // 产品ID
#define DEVID "h9sj8FzJ0gy.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1715129832027|" // 设备ID
#define AUTH_INFO "8bfa9c59778f5b338d76f7ada526cd115e2f2086ee951fffe2f42c2a39c2ebf5"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/h9sj8FzJ0gy/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/h9sj8FzJ0gy/test2" // 需要发布的主题

#define P_TOPIC_CMD "/sys/h9sj8FzJ0gy/smartdevice/thing/event/property/post"
...
typedef struct
{
	...
	U16 expressage_city;	 // 城市id
	U16 expressage_area;	 // 城市区
	U16 expressage_id;	 // 物料号
	U8 expressage_state;	 // 物料状态
	U8 expressage_app;	 // APP传输
	
	U8 transport_state;	 // 传输状态
	U8 transport_time;	 // 传输停止时间
